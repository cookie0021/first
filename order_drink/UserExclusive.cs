...
{
    public partial class UserExclusive : UserControl
    {
        FormOrder fgrid;
        public UserExclusive()
        {
            InitializeComponent();
        }


        public UserExclusive(FormOrder fg)
        {
            InitializeComponent();
            this.fgrid = fg;
        }

        private void UserExclusive_Load(object sender, EventArgs e)
        {
